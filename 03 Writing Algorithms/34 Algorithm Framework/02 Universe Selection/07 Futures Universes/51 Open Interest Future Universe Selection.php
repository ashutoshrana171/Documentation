...
self.add_universe_selection(
    OpenInterestFutureUniverseSelectionModel(
        self, 
        lambda utc_time: [Symbol.create(Futures.indices.sp500_emini, SecurityType.future, Market.CME)]
    )
)</pre>
</div>
...
def select_future_chain_symbols(self, utc_time: datetime) -&gt; List[Symbol]:
    return [ 
        Symbol.create(Futures.indices.sp500_emini, SecurityType.future, Market.CME),
